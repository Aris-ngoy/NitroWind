...
namespace margelo::nitro::nitrowind {
  ...
  /**
   * A struct which can be represented as a JavaScript object (TransitionOrigin).
   */
  struct TransitionOrigin final {
  public:
  ...
  public:
    ...
    explicit TransitionOrigin(double x, double y): x(x), y(y) {}

  public:
    friend bool operator==(const TransitionOrigin& lhs, const TransitionOrigin& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ TransitionOrigin <> JS TransitionOrigin (object)
  template <>
  struct JSIConverter<margelo::nitro::nitrowind::TransitionOrigin> final {
    static inline margelo::nitro::nitrowind::TransitionOrigin fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitrowind::TransitionOrigin(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitrowind::TransitionOrigin& arg) {
